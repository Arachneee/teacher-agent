...
public class FeedbackController {
    ...
    @PostMapping
    public ResponseEntity<FeedbackResponse> create(UserId userId, @RequestBody @Valid FeedbackCreateRequest request) {
        return ResponseEntity.status(201).body(feedbackService.create(userId, request));
    }

    @GetMapping
    public ResponseEntity<List<FeedbackResponse>> getAll(UserId userId, @RequestParam @Positive Long studentId) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<FeedbackResponse> update(UserId userId,
    ...
    public ResponseEntity<FeedbackResponse> generateAiContent(UserId userId, @PathVariable @Positive Long id) {
        return ResponseEntity.ok(feedbackService.generateAiContent(userId, id));
    }

    @PostMapping("/{id}/keywords")
    public ResponseEntity<FeedbackResponse> addKeyword(UserId userId,
                                                       @PathVariable @Positive Long id,
    ...
    public ResponseEntity<Void> removeKeyword(UserId userId,
                                              @PathVariable @Positive Long id,
